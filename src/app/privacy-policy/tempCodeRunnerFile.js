        ...
        <div className="h-full px-[30px] lg:px-[120px] pt-[120px]">
          <div className="flex rounded-[36px] border border-[#E5E5E5] shadow-md ">
            <div className="flex flex-col w-full p-[50px] justify-center bg-white rounded-[36px]">
              ...
              <Spacer height="40px" />
              <div className="text[32px] font-bold">Introduction</div>
              <Spacer height="30px" />
              ...
              <div className="text[32px] font-normal">
                ...
                Information about yourself in the process. Personal Information
              ...
              <div className="text[32px] font-normal">
                ...
                personal information. Third parties provide certain services
                available on the School Admin portal such as payment gateway
                services on UniVision’s behalf. UniVision may provide
                information, including Personal Information, that the Company
                collects on the Web to third-party service providers to help us
                deliver programs, products, information, and services.
                Additionally, service providers are also an important means by
                which the Company maintains its Web site and mailing lists.
              </div>
              <Spacer height="30px" />
              <div className="text[32px] font-normal">
              ...
              <Spacer height="40px" />
              <div className="text[32px] font-bold">User’s Consent</div>
              <Spacer height="30px" />
              <div className="text[32px] font-normal">
              ...
              <Spacer height="40px" />
              <div className="text[32px] font-bold">Contact Information</div>
              <Spacer height="30px" />
              <div className="text[32px] font-normal">
